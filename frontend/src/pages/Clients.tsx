  ...
  return (
    <div className="p-6">
      <div className="mb-6">
        ...
        <p className="text-gray-500 mt-1">Select a client to view their equipment</p>
      </div>
                ...
                clients.map((client) => (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2 mt-1 text-sm text-gray-500">
                      <span>{client.equipment_count} equipment{client.equipment_count !== 1 ? 's' : ''}</span>
        ...
        <div className="lg:col-span-2">
          {selectedClient ? (
            <div className="bg-white rounded-lg shadow">
              ...
              <div className="p-4 border-b">
                ...
                <button
                  ...
                  style={{ backgroundColor: '#1D4F91', cursor: 'pointer' }}
                >
                  + New Offer
                </button>
                </div>
              ...
              <div className="flex border-b">
                ...
                >
                  Modules ({clientEquipment.length})
                </button>
              </div>
                ...
                {loadingEquipment ? (
                  ...
                  <table className="w-full text-sm">
                    <thead className="bg-gray-50">
                      <tr>
                        <th className="px-4 py-3 text-left font-medium text-gray-600">Configuration</th>
                        ...
                        <th className="px-4 py-3 text-right font-medium text-gray-600">Year</th>
                      </tr>
                    </thead>
                      ...
                      {clientEquipment.length === 0 ? (
                        <tr>
                          <td colSpan={4} className="px-4 py-8 text-center text-gray-500">
                            No modules registered for this client
                          </td>
                        </tr>
                      ) : (
                          ...
                          <tr key={item.id} className="hover:bg-gray-50">
                            ...
                            <td className="px-4 py-3 text-right text-gray-900">
                              {item.import_amount != null
                                ? item.import_amount.toLocaleString('en-GB', { style: 'currency', currency: 'EUR' })
                                : '-'}
                            </td>
            ...
            <div className="bg-white rounded-lg shadow p-12 text-center text-gray-400">
              Select a client from the list to view their equipment
            </div>
          )}
        </div>
      </div>
